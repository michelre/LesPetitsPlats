...
const filterIngredientInput = document.querySelector('#filter_ingredients input');
...
[filterIngredientInput, filterUstensilsInput, filterAppareilsInput].forEach(input => {
